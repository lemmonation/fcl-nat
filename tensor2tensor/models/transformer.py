...
def transformer_base_v1():
  ...
  hparams.add_hparam("mask_noise_prob", 0.0)
  hparams.add_hparam("swap_window", 1)
  return hparams
...
@registry.register_hparams
def transformer_deep_small_iwslt16():
  hparams = transformer_base()
  hparams.num_hidden_layers = 5
  hparams.hidden_size = 508
  hparams.filter_size = 278
  hparams.num_heads = 2
  return hparams
